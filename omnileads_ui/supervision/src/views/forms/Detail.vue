<template>
  <div class="card">
    ...
    <div class='grid formgrid'>
      <div v-for="campo in formDetail.campos" :key="campo.id" class="field col-6 mt-4">
        ...
        <Dropdown class='mt-2 w-full' v-else-if='campo.tipo == 3' :options="JSON.parse(campo.values_select)" />
