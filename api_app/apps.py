    ...
    def configuraciones_de_permisos(self):
        return [
            ...
            {'nombre': 'api_pause_config_delete',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_sities_list',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_site_create',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_site_detail',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_site_update',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_site_delete',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
            {'nombre': 'api_external_site_hide',
             'roles': ['Administrador', 'Gerente', 'Supervisor']},
