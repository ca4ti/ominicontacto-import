...
class APITest(OMLBaseTest):
    ...
    def setUp(self):
        ...
        self.urls_api = {
            'ExternalSitiesList': 'api_external_sities_list',
            'ExternalSiteCreate': 'api_external_site_create',
            'ExternalSiteDetail': 'api_external_site_detail',
            'ExternalSiteUpdate': 'api_external_site_update',
            'ExternalSiteDelete': 'api_external_site_delete',
            'ExternalSiteHide': 'api_external_site_hide',
            'ExternalSiteShow': 'api_external_site_show',
        }


class SitiosExternosTest(APITest):
    def test_lista_sitios_externos(self):
        URL = reverse(self.urls_api['ExternalSitiesList'])
