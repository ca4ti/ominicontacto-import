...
urlpatterns = [
    ...
    # Sitios Externos
    # =========================
    url(r'api/v1/external_sities/$',
        SitioExternoList.as_view(),
        name='api_external_sities_list'),
    url(r'api/v1/external_sities/(?P<pk>\d+)/$',
        SitioExternoDetalle.as_view(),
        name='api_external_site_detail'),
    url(r'api/v1/external_sities/create/$',
        SitioExternoCreate.as_view(),
        name='api_external_site_create'),
    url(r'api/v1/external_sities/(?P<pk>\d+)/update/$',
        SitioExternoUpdate.as_view(),
        name='api_external_site_update'),
    url(r'api/v1/external_sities/(?P<pk>\d+)/delete/$',
        SitioExternoDelete.as_view(),
        name='api_external_site_delete'),
    url(r'api/v1/external_sities/(?P<pk>\d+)/hide/$',
        SitioExternoOcultar.as_view(),
        name='api_external_site_hide'),
