  ...
  <div class="mt-5 mb-5" v-if='isListType'>
        ...
        <div class="fluid grid formgrid">
          <div class="field col-6">
            ...
            >
            <small
              v-if='duplicateOptionName'
              class="p-error"
              >{{ $t('forms.form.validations.option_already_in_list') }}</small>
...
export default {
    ...
    methods: {
        ...mapActions(['addValueOption', 'removeValueOption', 'initOptionListValues']),
        initFormOptionData () {
        ...
        optionListNameEvent () {
            this.duplicateOptionName = this.optionListValues.find(data => data.nombre === this.optionList.nombre);
        },
